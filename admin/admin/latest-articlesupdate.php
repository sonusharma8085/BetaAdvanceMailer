<?php include('include/header.php'); 
  ...
  <?php 
     ...
     $sql   = mysqli_query($conn,"SELECT * FROM latest_articles WHERE id ='".$_GET['id']."'");
    ...
    $sql20 = "update latest_articles set title= '$title', subtitle='$subtitle',description='$price', image='$destfile' WHERE id =$id";
   ...
   // print_r($sql);die();
       if ($mysql==true) {
             //header('location:affiliatemarketing.php');
              ...
              header('location:latest-articlesupdate.php');
        }
         ...
         <div class="container">
            <form method="post" action="" enctype='multipart/form-data'>
               ...
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="price"  placeholder="Enter Description" value="<?php echo $row['description'] ?>">
               </div>
               <div class="form-group">
