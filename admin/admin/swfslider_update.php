...
<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM swf_slider");
  $sql   = mysqli_query($conn,"SELECT * FROM swf_slider WHERE id ='".$_GET['id']."'");
  $row   = mysqli_fetch_array($sql);
    ...
    $sql = "update swf_slider set id = $id, tittle= '$tittle', sub_tittle= '$sub_tittle' WHERE id =$id";
   ...
   if ($mysql==true) {
    ...
    echo '<script type="text/javascript">alert("Data not update")
        ...
        header('location:swfslider_update.php');
   }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-center">Update Sw Slider Feature</h1>
          </div><!-- /.col -->
          <!-- <div class="col-sm-6">
