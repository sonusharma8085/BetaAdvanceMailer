  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Trending software</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               <a href="user_data36_download.php" class="btn btn-primary" target="_blank">Data Export</a>
              <a href="trending-software-add.php"><i class="material-icons">add</i></a>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <th>Action</th>
                ...
                <?php 
                    ...
                    <tr class="text-center">
                        ...
                        <td><a href="trendingsw-update.php?id=<?php echo $result["id"]; ?>"><i class='far fa-edit' ></i></a>       
                            <a href="trendingsw-delete.php?id=<?php echo $result["id"]; ?>"><i class='far fa-trash-alt' ></i></a></td>
                </tr>
                    <?php 
                        $i++;
                    } ?>
