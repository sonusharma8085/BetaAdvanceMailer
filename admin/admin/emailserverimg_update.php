...
<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM emailserverimg");
  $sql   = mysqli_query($conn,"SELECT * FROM emailserverimg WHERE id ='".$_GET['id']."'");
  $row   = mysqli_fetch_array($sql);
    ...
    $sql = "update emailserverimg set id = $id, massage='$massage', image='$destfile' WHERE id =$id";
   ...
   if ($mysql==true) {
    ...
    echo "<script>location.href='emailserverimg_update.php'</script>";
   }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-center">Updat SEO Image</h1>
          </div><!-- /.col -->
          <!-- <div class="col-sm-6">
