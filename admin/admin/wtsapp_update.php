...
<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM whatsappmarketing");
  $sql   = mysqli_query($conn,"SELECT * FROM whatsappmarketing WHERE id ='".$_GET['id']."'");
  $row   = mysqli_fetch_array($sql);
    ...
    $sql = "update whatsappmarketing set id = $id, tittle='$tittle', image='$destfile' WHERE id =$id";
   ...
   if ($mysql==true) {
    ...
    echo '<script type="text/javascript">alert("Data not update")
        ...
        header('location:wtsapp_update.php');
   }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-center">Updat WhatsApp Image</h1>
          </div><!-- /.col -->
          <!-- <div class="col-sm-6">
