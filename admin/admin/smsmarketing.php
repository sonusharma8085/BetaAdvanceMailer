  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Sms Marketing</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <a href="user_data_download.php" class="btn btn-primary" target="_blank">Data Export</a>
          ...
          <table class="table table-striped text-center table-bordered">
            ...
            <tr class="text-center">
                                              ...
                                              <td><a data-toggle="tooltip" data-placement="top" title="update" href="smsmarketing_update.php?id=<?php echo $row["id"]; ?>"><i class='far fa-edit' ></i></a>       
                                                  <a data-toggle="tooltip" data-placement="top" title="delete" href="smsmarketing_delete.php?id=<?php echo $row["id"]; ?>"><i class='far fa-trash-alt' ></i></a></td>
                                            </tr>
