...
<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM swdeve_latest");
  $sql   = mysqli_query($conn,"SELECT * FROM swdeve_latest WHERE id ='".$_GET['id']."'");
  $row   = mysqli_fetch_array($sql);
    ...
    $sql = "update swdeve_latest set id = $id, tittle= '$tittle', sub_tittle='$sub_tittle', image='$destfile' WHERE id =$id";
   ...
   if ($mysql==true) {
    ...
    echo '<script type="text/javascript">alert("Data not update")
        ...
        header('location:swdevelatest_update.php');
   }
