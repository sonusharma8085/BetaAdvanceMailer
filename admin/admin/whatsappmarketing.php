...
<?php 
  ...
  <?php 
    ...
    $sql = "INSERT INTO `whatsappmarketing`(`tittle`, `image`) VALUES ('$tittle','$destfile')";
   ...
   if ($mysql==true) {
    ...
    echo '<script type="text/javascript">alert("Succesfully Data Inserted")
        ...
        header('location:whatsappmarketing.php');
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Whatsapp Marketing</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               <a href="user_data30_download.php" class="btn btn-primary" target="_blank">Data Export</a>
        ...
        <div class="row">
          ...
          <table class="table table-striped text-center table-bordered">
            ...
            <tr class="text-center">
                                              ...
                                              <td><a data-toggle="tooltip" data-placement="top" title="update" href="wtsapp_update.php?id=<?php echo $row["id"]; ?>"><i class='far fa-edit' ></i></a>       
                                                  <a data-toggle="tooltip" data-placement="top" title="delete" href="wtsapp_delete.php?id=<?php echo $row["id"]; ?>"><i class='far fa-trash-alt' ></i></a></td>
                                            </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-center" id="exampleModalLabel">WhatsApp Marketing</h5>
