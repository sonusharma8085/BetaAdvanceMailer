...
<?php 
  ...
  <?php 
    ...
    $sql = "INSERT INTO `byhosting`(`tittle`, `sub_tittle`,`image`) VALUES ('$tittle','$sub_tittle', '$destfile')";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">By Hosting</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <a href="user_data31_download.php" class="btn btn-primary" target="_blank">Data Export</a>
        ...
        <div class="row">
          ...
          <table class="table table-striped text-center table-bordered">
            ...
            <tr class="text-center">
                  ...
                  <td><a data-toggle="tooltip" data-placement="top" title="update" href="hosting_update.php?id=<?php echo $row["id"]; ?>"><i class='far fa-edit' ></i></a>       
                  <a data-toggle="tooltip" data-placement="top" title="delete" href="hosting_delete.php?id=<?php echo $row["id"]; ?>"><i class='far fa-trash-alt' ></i></a></td>
           </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-center" id="exampleModalLabel">By Hosting</h5>
