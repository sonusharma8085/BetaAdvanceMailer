...
<?php 
    ...
    $sql = "INSERT INTO `googleadsimg`(`tittle`,`image`) VALUES ('$tittle','$destfile')";
   ...
   if ($mysql==true) {
    ...
    echo "<script>location.href='googleadvertsetup.php'</script>";
        ...
        header('location:googleadsimg.php');
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <input class="form-control" type="text" name="tittle" required="" placeholder="plz enter Massage" rows="4" cols="25"></input>
                </div> 
                <div class="col-sm-6">
