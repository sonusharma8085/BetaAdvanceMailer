...
<!--       <div class="modal-footer text-center">
        ...
        <div class="row col-sm-12">
          ...
          <div class="container-fluid">
            <div class="row">
          <div class="col-md-6">
            <h3>Data Recovery Image</h3>
          </div>
          <div class="col-md-6 text-right">
             <a href="user_data19_download.php" class="btn btn-primary" target="_blank">Data Export</a>
            <a href="datarecoveryimg.php" class="text-right" data-placement="top" title="Add" ><i class="material-icons">add</i></a>
          </div>
        </div>
      </div>
          </div>
          ...
          <table class="table table-striped text-center table-bordered">
            ...
            <tr class="text-center">
                                              ...
                                              <td><a data-toggle="tooltip" data-placement="top" title="update" href="datarecimg_update.php?id=<?php echo $row["id"]; ?>"><i class='far fa-edit' ></i></a>       
                                                  <a data-toggle="tooltip" data-placement="top" title="delete" href="datarecimg_delete.php?id=<?php echo $row["id"]; ?>"><i class='far fa-trash-alt' ></i></a></td>
                                            </tr>
