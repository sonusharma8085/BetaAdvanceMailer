...
<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM seo_tittle");
  $sql   = mysqli_query($conn,"SELECT * FROM seo_tittle WHERE id ='".$_GET['id']."'");
  $row   = mysqli_fetch_array($sql);
    ...
    $sql = "update seo_tittle set id = $id, tittle= '$tittle' WHERE id =$id";
   ...
   if ($mysql==true) {
    ...
    echo '<script type="text/javascript">alert("Data not update")
        ...
        header('location:seo_tittle_update.php');
   }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-center">Update SEO Tittle</h1>
          </div><!-- /.col -->
          <!-- <div class="col-sm-6">
