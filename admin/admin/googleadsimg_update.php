...
<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM googleadsimg");
  $sql   = mysqli_query($conn,"SELECT * FROM googleadsimg WHERE id ='".$_GET['id']."'");
  $row   = mysqli_fetch_array($sql);
    ...
    $sql = "update googleadsimg set id = $id, tittle='$tittle', image='$destfile' WHERE id =$id";

     $mysql = mysqli_query($conn,$sql);
   // print_r($sql);die();
   if ($mysql==true) {
    //header('location:googleadvertsetup.php');
    ...
    echo '<script type="text/javascript">alert("Data not update")
        ...
        header('location:googleadsimg_update.php');
   }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-center">Updat Google Ads Image</h1>
          </div><!-- /.col -->
          <!-- <div class="col-sm-6">
