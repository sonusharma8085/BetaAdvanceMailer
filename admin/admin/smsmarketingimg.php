...
<?php 
    ...
    $sql = "INSERT INTO `smsmarketing_img`(`massage`,`image`) VALUES ('$massage','$destfile')";
   ...
   if ($mysql==true) {
    ...
    echo '<script type="text/javascript">alert("Succesfully Data Inserted")</script>';
     echo "<script>location.href='smsmarketing.php'</script>";
        ...
        header('location:seoimg_deve.php');
          ...
          <div class="container">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <label>Tittle :-</label>
                  <input type="text" name="massage" required="" placeholder="plz enter Tittle" rows="4" cols="25"></input>
                </div> 
                <div class="col-sm-6">
