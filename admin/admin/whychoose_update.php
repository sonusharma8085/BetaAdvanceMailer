...
<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM whychoose");
  $sql   = mysqli_query($conn,"SELECT * FROM whychoose WHERE id ='".$_GET['id']."'");
  $row   = mysqli_fetch_array($sql);
    ...
    $sql = "update whychoose set id = $id, tittle='$tittle', sub_tittle='$sub_tittle', image='$destfile' WHERE id =$id";
   ...
   if ($mysql==true) {
    ...
    echo '<script type="text/javascript">alert("Data not update")
        ...
        header('location:whychoose_update.php');
   }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-center">Updat why choose us</h1>
          </div><!-- /.col -->
          <!-- <div class="col-sm-6">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="row col-sm-6">
                <div class="col-sm-6">
                  ...
                  <input class="form-control" id="exampleFormControlInput1" type="text" name="tittle" required="" placeholder="plz enter Tittle" value="<?php echo $row["tittle"]; ?>"></input>
                </div>
                <!-- <div class="col-sm-6">
              ...
              <div class="row col-sm-6">
                <div class="col-sm-6">
                  ...
                  <input class="form-control" id="exampleFormControlInput1" type="text" name="sub_tittle" required="" placeholder="plz enter Tittle" value="<?php echo $row["sub_tittle"]; ?>"></input>
                </div>
                <div class="col-sm-6">
