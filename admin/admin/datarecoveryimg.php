...
<?php 
    ...
    $sql = "INSERT INTO `datarecimg`(`tittle`,`image`) VALUES ('$tittle','$destfile')";
   ...
   if ($mysql==true) {
    ...
    echo "<script>location.href='datarecovery.php'</script>";
        ...
        header('location:datarecoveryimg.php');
          ...
          <div class="container">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <label>Tittle :-</label>
                  <input type="text" name="tittle" required="" placeholder="plz enter Tittle" rows="4" cols="25"></input>
                </div> 
                <div class="col-sm-6">
