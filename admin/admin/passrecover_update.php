...
<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM passrecover");
  $sql   = mysqli_query($conn,"SELECT * FROM passrecover WHERE id ='".$_GET['id']."'");
  $row   = mysqli_fetch_array($sql);
    ...
    $sql = "update passrecover set id = $id, tittle= '$tittle', sub_tittle='$sub_tittle',massage='$massage', image='$destfile' WHERE id =$id";
   ...
   if ($mysql==true) {
    ...
    echo '<script type="text/javascript">alert("Succesfully Data update")
        ...
        echo "<script>location.href='passwordrecovery.php'</script>";
    }else{

    echo '<script type="text/javascript">alert("Data not update")
        </script>';
        //header('location:emailserver_update.php');
        echo "<script>location.href='passrecover_update.php'</script>";
   }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-center">Update Pass Recovery</h1>
          </div><!-- /.col -->
          <!-- <div class="col-sm-6">
