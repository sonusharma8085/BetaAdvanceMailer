...
<?php 
$id = $_GET['id'];
$sql   = mysqli_query($conn,"SELECT * FROM ourtools_slider WHERE id ='".$_GET['id']."'");
...
$sql20 = "update ourtools_slider set title= '$title', subtitle='$subtitle', image='$destfile' WHERE id =$id";
...
header('location:ourtools-slider-update.php');
}
}
?>
