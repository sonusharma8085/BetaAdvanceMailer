...
<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM workimg");
  $sql   = mysqli_query($conn,"SELECT * FROM workimg WHERE id ='".$_GET['id']."'");
  $row   = mysqli_fetch_array($sql);
    ...
    $sql = "update workimg set id = $id, tittle='$tittle', image='$destfile' WHERE id =$id";
   ...
   if ($mysql==true) {
    ...
    echo '<script type="text/javascript">alert("Data not update")
        ...
        header('location:workimg_update.php');
   }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-center">Update WorkProgress</h1>
          </div><!-- /.col -->
          <!-- <div class="col-sm-6">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="row col-sm-6">
                <div class="col-sm-6">
                  ...
                  <input class="form-control" type="text" name="tittle" required="" value="<?php echo $row["tittle"]; ?>"></input>
                </div>
                <!-- <div class="col-sm-6">
