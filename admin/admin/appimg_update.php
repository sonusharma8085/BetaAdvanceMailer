...
<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM mob_app1");
  $sql   = mysqli_query($conn,"SELECT * FROM mob_app1 WHERE id ='".$_GET['id']."'");
  $row   = mysqli_fetch_array($sql);
    ...
    $sql = "update mob_app1 set id = $id, massge= '$massage', image='$destfile' WHERE id =$id";
   ...
   if ($mysql==true) {
    ...
    echo '<script type="text/javascript">alert("Data not update")
        ...
        header('location:appimg_update.php');
   }
