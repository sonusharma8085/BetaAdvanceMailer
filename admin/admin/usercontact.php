...
<a href="user_data10_download.php" class="btn btn-primary" target="_blank">Data Export</a>
...
<!-- <a href="swfeaturetittle.php" class="text-right" data-placement="top" title="Add" ><i class="material-icons " >add</i></a> -->
</div>
</div>
</div>
</div>
