...
<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM seo_img");
  $sql   = mysqli_query($conn,"SELECT * FROM seo_img WHERE id ='".$_GET['id']."'");
  $row   = mysqli_fetch_array($sql);
    ...
    $sql = "update seo_img set id = $id, massage='$massage', image='$destfile' WHERE id =$id";
