        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <a href="user_data24_download.php" class="btn btn-primary" target="_blank">Data Export</a>
        ...
        <div class="row">
          ...
          <table class="table table-striped text-center table-bordered">
            ...
            <tr class="text-center">
                                              ...
                                              <td><a data-toggle="tooltip" data-placement="top" title="update" href="seo_update.php?id=<?php echo $row["id"]; ?>"><i class='far fa-edit' ></i></a>       
                                                  <a data-toggle="tooltip" data-placement="top" title="delete" href="seo_delete.php?id=<?php echo $row["id"]; ?>"><i class='far fa-trash-alt' ></i></a></td>
                                            </tr>
