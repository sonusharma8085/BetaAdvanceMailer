...
<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM afiliateimg");
  $sql   = mysqli_query($conn,"SELECT * FROM afiliateimg WHERE id ='".$_GET['id']."'");
  $row   = mysqli_fetch_array($sql);
    ...
    $sql = "update afiliateimg set id = $id, massage='$massage', image='$destfile' WHERE id =$id";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-center">Updat Afiliate Image</h1>
          </div><!-- /.col -->
          <!-- <div class="col-sm-6">
