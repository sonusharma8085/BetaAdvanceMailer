...
<?php 
   ...
   $sql = "INSERT INTO `latest_arti_img`(`title`, `subtitle`, `image`, `created_at`) VALUES ('$title','$subtitle','$destfile','$currentTime')";
   ...
   //header('location:afiliateimg.php');
       ...
       header('location:latest-articles-img-add.php');
...
<div class="content-wrapper">
   <section class="content">
      <div class="container-fluid">
         ...
         <div class="row">
            <div class="col-md-12">
               <h1>Add Latest articles image </h1>
            </div>
            <!--  <div class="col-md-6">
