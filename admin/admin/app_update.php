...
<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM app_dev");
  $sql   = mysqli_query($conn,"SELECT * FROM app_dev WHERE id ='".$_GET['id']."'");
  $row   = mysqli_fetch_array($sql);
    ...
    $sql = "update app_dev set id = $id, tittle= '$tittle', sub_tittle='$sub_tittle', image='$destfile' WHERE id =$id";
