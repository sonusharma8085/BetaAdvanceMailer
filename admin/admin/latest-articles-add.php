...
<?php 
   ...
   $sql = "INSERT INTO `latest_articles`(`title`, `subtitle`, `image`, `pdf`, `description`, `created_at`) VALUES ('$title','$subtitle','$destfile','$pdf','$price','$currentTime')";
   ...
   //header('location:afiliateimg.php');
       ...
       header('location:latest-articles-add.php');
