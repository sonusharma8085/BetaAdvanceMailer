<?php include('include/header.php'); 
  ...
  <?php 
     ...
     $sql   = mysqli_query($conn,"SELECT * FROM trendingsw WHERE id ='".$_GET['id']."'");
  ...
  $price      =  $_POST['price'];
    ...
    $sql20 = "update trendingsw set title= '$title', subtitle='$subtitle',price='$price', image='$destfile' WHERE id =$id";
       ...
       if ($mysql==true) {
            ...
            echo "<script>location.href='trending_software.php'</script>";
             ...
             echo '<script type="text/javascript">alert("Data not update")</script>';
              header('location:trendingsw_update.php');
        }
      ...
      <div class="row col-md-8">
         <div class="container">
            <form method="post" action="" enctype='multipart/form-data'>
               ...
               <div class="form-group">
                  <label for="exampleInputPassword1">Sub-Title</label>
                  <input type="text" class="form-control" name="price"  placeholder="Enter Subtitle" value="<?php echo $row['price'] ?>">
               </div>
               <div class="form-group">
