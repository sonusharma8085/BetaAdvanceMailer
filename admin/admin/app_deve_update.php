...
<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM mob_app");
  $sql   = mysqli_query($conn,"SELECT * FROM mob_app WHERE id ='".$_GET['id']."'");
  $row   = mysqli_fetch_array($sql);
    ...
    $sql = "update mob_app set id = $id, tittle= '$tittle', sub_tittle='$sub_tittle' WHERE id =$id";
   ...
   if ($mysql==true) {
    ...
    echo '<script type="text/javascript">alert("Data not update")
        ...
        header('location:app_deve_update.php');
   }
