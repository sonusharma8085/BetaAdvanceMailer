...
$sql = "INSERT INTO `passrecover`(`tittle`,`sub_tittle`,`massage`,`image`) VALUES ('$tittle','$sub_tittle','$massage','$destfile')";
...
<td><a data-toggle="tooltip" data-placement="top" title="update" href="passrecover_update.php?id=<?php echo $row["id"]; ?>"><i class='far fa-edit' ></i></a>       
<a data-toggle="tooltip" data-placement="top" title="delete" href="paasrecover_delete.php?id=<?php echo $row["id"]; ?>"><i class='far fa-trash-alt' ></i></a></td>
</tr>
<?php
}
?>
