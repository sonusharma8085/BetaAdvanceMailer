...
<?php 
  ...
  $query = mysqli_query($conn,"SELECT * FROM bydomain");
  $sql   = mysqli_query($conn,"SELECT * FROM bydomain WHERE id ='".$_GET['id']."'");
  $row   = mysqli_fetch_array($sql);
    ...
    $sql = "update bydomain set id = $id, tittle= '$tittle', sub_tittle='$sub_tittle', image='$destfile' WHERE id =$id";
   ...
   if ($mysql==true) {
    ...
    echo '<script type="text/javascript">alert("Data not update")
        ...
        header('location:bydomain_update.php');
   }
